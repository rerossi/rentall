                ...
                <div class="container-fluid">
                    <div class="row w-100">
                        ...
                        <div class="col-8">
                            <div class="justify-content-center mt-2 row" style="margin-left: 70px;">
                                <form class="d-flex col-8">
                                    <input class="form-control me-2" style="min-width: auto; " type="search"
                        ...
                        <div class="col-2 text-end">
                            ...
                            <a href="#" style="text-decoration: none;"> <img src="./image/sair.png" width="25px"
                            ...
                            <ul class="nav justify-content-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"
                                        style="color:white; font-weight:lighter">Catálogo</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"
                                        style="color:white; font-weight:lighter">Cadastrar produto</a>
                                </li>
                            </ul>
                        </div>
                    </div>
